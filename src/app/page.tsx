                  ...
                  <li className="sidebar-menu-category">
                    ...
                    <button className="sidebar-accordion-menu" data-accordion-btn>
                      ...
                      <div className="menu-title-flex">
                        <Image src="./assets/images/icons/dress.svg" alt="clothes" width="20" height="20"
                  ...
                  <div className="showcase-container">
                    ...
                    <div className="showcase">
                      ...
                      <a href="#" className="showcase-img-box">
                        <Image src="./assets/images/products/1.jpg" alt="baby fabric shoes" width="75" height="75" className="showcase-img" />
                      </a>
                    ...
                    <div className="showcase">
                      ...
                      <a href="#" className="showcase-img-box">
                        <Image src="./assets/images/products/2.jpg" alt="men's hoodies t-shirt" className="showcase-img"
                          width="75" height="75" />
                      </a>
                    ...
                    <div className="showcase">
                      ...
                      <a href="#" className="showcase-img-box">
                        <Image src="./assets/images/products/3.jpg" alt="girls t-shirt" className="showcase-img" width="75"
                          height="75" />
                      </a>
                    ...
                    <div className="showcase">
                      ...
                      <a href="#" className="showcase-img-box">
                        <Image src="./assets/images/products/4.jpg" alt="woolen hat for men" className="showcase-img" width="75"
                          height="75" />
                      </a>
