...
import { settingsOutline, buildOutline, hammerOutline, cogOutline, batteryHalfOutline, ellipse, heartOutline, homeOutline, logoFacebook, logoInstagram, logoLinkedin, logoTwitter, menuOutline, removeOutline, searchOutline } from 'ionicons/icons';


export default function ProdukCategoryDetail() {
  const [products, setProducts] = useState<any>(null);  // Default to null for the entire data
    ...
    if (currentSlug) {
      const fetchProductDetail = async () => {
        try {
          ...
          console.log('API Response:', response.data);  // Log the entire response to check the data structure
  ...
  // Log products to ensure they are set correctly
                ...
                <div className="flex items-center justify-between gap-6 mb-6">
                  <div className="text">
                    <h2 className="font-manrope font-bold text-3xl leading-10 text-gray-900 mb-2">
                      <h3>{products?.title ? products.title : 'Product title not available'}</h3>
                    </h2>
